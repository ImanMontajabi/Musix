...
MDockedToolbar {
    ...
    MButton { symbol: "close"; tip: "Clear selection · "+Keymap.label("Esc"); implicitWidth: 40; implicitHeight: 40; onClicked: bar.view.selection.clear() }
    ...
    MButton { symbol: "remove"; tip: "Remove selected · "+Keymap.label("Delete"); visible: bar.canRemove; implicitWidth: 40; implicitHeight: 40; onClicked: bar.view.removeSelected() }
}
