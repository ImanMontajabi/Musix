...
QtObject {
    ...
    property FileDialog exportPicker: FileDialog { parentWindow: dialogs.ownerWindow; objectName: "exportPicker"; title: "Export library"; fileMode: FileDialog.SaveFile; defaultSuffix: "json"; nameFilters: ["Musix library (*.json)"]; onAccepted: app.exportLibrary(selectedFile) }
    property FileDialog importPicker: FileDialog { parentWindow: dialogs.ownerWindow; objectName: "importPicker"; title: "Import library"; nameFilters: ["Musix library (*.json)"]; onAccepted: app.importLibrary(selectedFile) }
