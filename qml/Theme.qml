...
QtObject {
    ...
    // A Catppuccin, Gruvbox or Rosé Pine accent is a seed like any other, in
    // the variant its palette gives for this theme; the scheme is derived from
    // it the same way, surfaces included.
    property color accentSeed: app.accentColor.startsWith("#") ? app.accentColor
                             : AccentPalettes.hex(app.accentColor, dark) || "transparent"
