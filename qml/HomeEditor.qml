...
MDialog {
    ...
    ColumnLayout {anchors.fill:parent;spacing:Theme.space12
        ListView {id:list;objectName:"homeEditorList";Layout.fillWidth:true;Layout.fillHeight:true;clip:true;spacing:Theme.space8;model:dialog.sections;reuseItems:true
            ...
            delegate:Rectangle {required property var modelData;required property int index;width:list.width;height:64;radius:Theme.shapeLarge;color:Theme.high
                RowLayout {anchors.fill:parent;anchors.margins:Theme.space8;spacing:Theme.space4
                    MSwitch {objectName:"homeVisible_"+index;text:modelData.title;leftPadding:Theme.space8;Layout.fillWidth:true;checked:modelData.shown;onToggled:app.showHomeSection(modelData.title,checked)}
        ...
        MButton {objectName:"homeLayoutReset";text:"Reset layout";leftAligned:true;contentInset:Theme.space16;onClicked:app.resetHomeLayout()}
    }
}
